                        ...
                        <nav className=' md:flex gap-3 text-lg items-center max-sm:my-3 hidden'>
                             <NavLink to = '/' className='hover:bg-gray-300 hover:cursor-pointer rounded'>Home</NavLink>
                                ...
                                <div className='md:hidden'>
                                        {isOpen? ( <RiCloseLine size={30} onClick={toggle} />) :
                                                                                                         ...
                                                                                                         {isOpen && (
                                                                                                                                        <nav className='absolute left-0 right-0 top-full md:hidden bg-white shadow border-t transition-all duration-200 ease-out'>
                                                                                                                                                <div className='flex flex-col text-lg'>
                                                                                                                                                        <NavLink to='/' onClick={() => setIsOpen(false)} className='block w-full text-center py-3 hover:bg-gray-100 border-b'>Home</NavLink>
                                                                                                                                                        <NavLink to='/about' onClick={() => setIsOpen(false)} className='block w-full text-center py-3 hover:bg-gray-100 border-b'>About</NavLink>
                                                                                                                                                        <NavLink to='/contact' onClick={() => setIsOpen(false)} className='block w-full text-center py-3 hover:bg-gray-100'>Contact</NavLink>
                                                                                                                                                </div>
                                                                                                                                </nav>
                                                                                                         )} 
                </div>
